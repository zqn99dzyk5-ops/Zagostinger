              ...
              <div key={p.id} className="bg-[#0f0f0f] border border-white/10 rounded-3xl overflow-hidden hover:border-pink-500/30 transition-all duration-300 flex flex-col hover:shadow-2xl hover:shadow-pink-500/10 group">
                ...
                <div className="p-8 flex flex-col gap-4 flex-1">
                  ...
                  <div className="text-3xl font-bold text-white">
                    €{p.price} <span className="text-sm text-white/40 font-normal">/mjesečno</span>
                  </div>
        ...
        <div className="max-w-7xl mx-auto relative overflow-hidden rounded-[3rem] p-12 md:p-20 flex flex-col md:flex-row items-center justify-between gap-10">
          ...
          <div className="relative z-10 text-center md:text-left">
            ...
            <p className="text-white/90 text-xl font-medium tracking-wide">
              Pridruži se Discord serveru sa 1,500+ članova.
            </p>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-6 grid grid-cols-2 md:grid-cols-4 gap-12">
          {[
            ...
            <div key={i} className="text-center">
              <div className="text-4xl md:text-5xl font-bold mb-2 text-transparent bg-clip-text bg-gradient-to-r from-orange-400 to-pink-500">
                {s.value}
              </div>
