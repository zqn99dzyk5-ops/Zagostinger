...
const Home = () => {
  ...
  return (
    <div className="relative min-h-screen bg-[#050505] text-white font-sans isolate selection:bg-pink-500/30">
      ...
      {/* --- GLOW EFEKTI (SLOJ z-1) --- */}
      <div className="fixed inset-0 overflow-hidden pointer-events-none z-[1]">
        <div className="absolute top-[-10%] left-[-10%] w-[80vw] h-[80vw] bg-orange-600/15 blur-[120px] rounded-full mix-blend-screen opacity-60 animate-pulse" style={{ animationDuration: '8s' }} />
        <div className="absolute bottom-[-10%] right-[-10%] w-[80vw] h-[80vw] bg-pink-600/10 blur-[120px] rounded-full mix-blend-screen opacity-50" />
      </div>

      {/* --- SADRŽAJ (SLOJ z-10) --- */}
      <div className="relative z-[10]">

        {/* 1. TOP BANNER (10% veći, rounded na PC-u, bez cropa) */}
        <div className="w-full mt-20 px-0 md:px-10">
          <div className="max-w-[1440px] mx-auto relative overflow-hidden rounded-none md:rounded-[3rem] bg-black border-b md:border border-white/10 shadow-2xl">
            <img 
              src={settings.hero_image_url || "https://i.ibb.co/Ktb6Frq/b2ec6e8f-c260-4f94-9c9b-24a67bb65af5.jpg"}
              // md:max-h-[600px] limitira visinu da ne pojede ekran
              // object-contain osigurava da se cijela slika vidi
              className="w-full h-auto md:max-h-[600px] object-contain block mx-auto opacity-100"
              alt="Banner"
            />
            {/* Blagi prelaz na dnu slike */}
        ...
        <section id="programs" className="py-24 max-w-7xl mx-auto px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
            {programs.map((p) => (
              <div key={p.id} className="bg-[#0f0f0f]/60 backdrop-blur-xl border border-white/10 rounded-[2rem] overflow-hidden hover:border-orange-500/50 transition-all duration-300 flex flex-col hover:shadow-[0_0_50px_rgba(234,88,12,0.1)] group">
        ...
        <section className="py-24 max-w-4xl mx-auto px-6 italic">
          ...
          <div className="space-y-4">
            {faqs.map((faq, index) => (
              <div key={faq.id || index} className="border border-white/10 rounded-2xl bg-[#0a0a0a]/60 backdrop-blur-md overflow-hidden">
        ...
        <section className="py-20 px-6">
          <div className="max-w-7xl mx-auto relative overflow-hidden rounded-[3.5rem] p-12 md:p-24 flex flex-col md:flex-row items-center justify-between gap-10 shadow-2xl">
        ...
        <section className="py-32 bg-black/40 border-t border-white/5 backdrop-blur-md">
          <div className="max-w-7xl mx-auto px-6 grid grid-cols-2 md:grid-cols-4 gap-12 text-center">
            {[
              ...
              <div key={i}>
                <div className="text-5xl md:text-7xl font-black mb-2 text-transparent bg-clip-text bg-gradient-to-r from-orange-500 to-pink-600 italic">{s.value}</div>
